...
tello_address = ('192.168.3.16', 8889)     # 设置tello主机及端口号
tello_address2 = ('192.168.3.14', 8889)
tello_address3 = ('192.168.3.11', 8889)
tello_address4 = ('192.168.3.21', 8889)
...
while True:
    if flag == 0:
        ...
        msg = "EXT led br 1 255 255 0"  # 输入指令
        msg = msg.encode(encoding="utf-8")  # 对要发送的信息进行编码
        sock.sendto(msg, tello_address)  # 发送UDP数据
        sock2.sendto(msg, tello_address2)  # 发送UDP数据
        sock3.sendto(msg, tello_address3)  # 发送UDP数据
        ...
        msg = "EXT mled l r 0.2 GEEKUP2020"  # 输入指令
        msg = msg.encode(encoding="utf-8")  # 对要发送的信息进行编码
        sock.sendto(msg, tello_address)  # 发送UDP数据
        sock2.sendto(msg, tello_address2)  # 发送UDP数据
        sock3.sendto(msg, tello_address3)  # 发送UDP数据
